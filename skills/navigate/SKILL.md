---
name: hiivmind-corpus-fastmail-navigate
description: This skill answers questions about Fastmail documentation. Use when user asks about Fastmail, JMAP, email APIs, mail servers, or email automation. Triggers: fastmail, jmap, email, api, mail server, email automation, json meta application protocol.
---

# Fastmail Documentation Navigator
...
- **Domain terms**: Technical concepts that might appear in docs
...
```
/hiivmind-corpus refresh fastmail     - Update index from upstream
/hiivmind-corpus enhance fastmail X   - Add depth to topic X
/hiivmind-corpus status fastmail      - Check corpus freshness
```
