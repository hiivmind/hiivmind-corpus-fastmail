---
description: Ask questions about Fastmail documentation
...
# Fastmail Corpus Navigator

Direct access to Fastmail documentation.
...
```
Fastmail Corpus - ask me anything!

Examples:
  /hiivmind-corpus-fastmail:navigate how does X work?
  /hiivmind-corpus-fastmail:navigate API reference for Y

For maintenance, use the corpus gateway:
  /hiivmind-corpus:hiivmind-corpus refresh fastmail
  /hiivmind-corpus:hiivmind-corpus enhance fastmail [topic]
```
...
3. **Identify an index gap** - If the user confirms their request was valid
   ...
   - Offer next steps:
     - `/hiivmind-corpus:hiivmind-corpus enhance fastmail {topic}` - Add depth to a specific topic area
     - `/hiivmind-corpus:hiivmind-corpus add-source fastmail` - Add another documentation source
     - `/hiivmind-corpus:hiivmind-corpus refresh fastmail` - Check if upstream docs have new content
...
If you're working in a project that uses Fastmail but doesn't know about this corpus, you can add awareness to the project's CLAUDE.md.
...
- User is working in a project that heavily uses Fastmail
- User repeatedly asks Fastmail questions without invoking the corpus
...
**User:** `/hiivmind-corpus-fastmail:navigate how do I use feature X?`

1. Grep `data/` for "feature X"
2. Find entry like `fastmail-api:guides/feature-x.md`
3. Read from `.cache/web/fastmail-api/guides/feature-x.md`
...
```
/hiivmind-corpus:hiivmind-corpus refresh fastmail     - Update index from upstream
/hiivmind-corpus:hiivmind-corpus enhance fastmail X   - Add depth to topic X
/hiivmind-corpus:hiivmind-corpus status fastmail      - Check corpus freshness
```
